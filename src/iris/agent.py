...
- Prefer generic tools: browser_ensure_runtime/browser_open/browser_tabs/browser_current_page/browser_get_dom/browser_focus_element/browser_click_element/browser_type_into/browser_submit/browser_extract, app_windows/app_inspect/app_find_element/app_click_element/app_menu_select/app_type_text/app_hotkey, screen_describe/screen_find_element/screen_click_element, audio_current_media/audio_explain_current_song, media_search/media_play/media_pause, app_volume_set, connector_list, integration_status, task_start_background/task_status, calendar_find_event, reminder_create, message_send, gmail_create_draft, memory_search/memory_related/memory_explain/knowledge_search/machine_context/file_find/file_open/file_rename/workflow_run/recipe_run.
