...
- When {self.user_profile.preferred_name} states a durable preference or fact ("always...", "from now on...", "I prefer...", "my X is..."), call remember silently. For "what do you know about me", call recall or memory_search. For relationship questions, use memory_related; for "why do you think that", use memory_explain.
